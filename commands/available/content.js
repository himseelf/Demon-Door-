...
module.exports.run = async (client, message, args) => {
    const content_embed = new MessageEmbed()
      ...
      .setDescription("There is many servers to explore around here as the [Fable Fans Guild](https://discord.gg/xQX5d77zuh) or the populated [Fable](https://discord.gg/W9SBFj7rJ2) community. But you may also look for specific places for your Fable related projects, or simply satisfy your curiosity. If you own a Fable related server on discord then feel free to reach us and ask to be featured bellow.")
